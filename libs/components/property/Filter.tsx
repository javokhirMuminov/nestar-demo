  ...
  return (
    <Stack className={"filter-main"}>
      ...
      <Stack className="find-your-home">
        <p className="title" style={{ textShadow: "0 3px 4px #b9b9b9" }}>
          Location
        </p>
        <Stack
        ...
        >
          {["New York", "San Francisco", "Chicago"].map((location: string) => {
            return (
      ...
      <Stack className="find-your-home" mb={"30px"}>
        <Typography className="title">Bath rooms</Typography>
        <Stack className="button-group">
          <Button
            sx={{
              borderRadius: "12px 0 0 12px",
      ...
      <Stack className="find-your-home" mb={"30px"}>
        <Typography className="title">Square feet</Typography>
